...
def parseArgs():
    ...
    return args.input, args.number, args.second_number, args.output, args.particular_name

def ExtractPoseFromTrajectory(trajectory, number, second_number, output, particular_name):
	"""
...
def main():
    ...
    trajectory, number, second_number, output, particular_name = parseArgs()
    ...
    ExtractPoseFromTrajectory(trajectory, number, second_number, output, particular_name)
